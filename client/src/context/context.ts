...
SKIPPED_CONFIGURATION.add(ContextKey.AUTO_SUGGEST);
SKIPPED_CONFIGURATION.add(ContextKey.BEM);
SKIPPED_CONFIGURATION.add(ContextKey.DENSITY);
SKIPPED_CONFIGURATION.add(ContextKey.OVERRIDE);
SKIPPED_CONFIGURATION.add(ContextKey.DESIGN_TOKEN);
SKIPPED_CONFIGURATION.add(ContextKey.INVALID);
SKIPPED_CONFIGURATION.add(ContextKey.UTILITY_CLASS);
SKIPPED_CONFIGURATION.add(ContextKey.DEPRECATED);
SKIPPED_CONFIGURATION.add(ContextKey.SCOPE);
SKIPPED_CONFIGURATION.add(ContextKey.SLDS_MOBILE_VALIDATION);
SKIPPED_CONFIGURATION.add(ContextKey.WCAG);
